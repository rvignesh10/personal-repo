...
// 0 if not found
// ------------------------------------------------------------------------------------
int parseCommand( const string & line, const string & command, int & value, bool echo) {
...
// Parse a double
int parseCommand( const string & line, const string & command, double & value, bool echo) {
    int len =command.length();
    if( line.substr(0,len)==command ) {
...
// Parse a string
int parseCommand( const string & line, const string & command, string & value, bool echo) {
    int len =command.length();
    if( line.substr(0,len)==command ) {

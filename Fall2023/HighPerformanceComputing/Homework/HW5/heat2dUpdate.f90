...
!
subroutine heat2dUpdate( n1a,n1b,n2a,n2b, nd1a,nd1b, nd2a,nd2b, un,u, rx, ry,nThreads )

  implicit none
  integer n1a,n1b,n2a,n2b,nd1a,nd1b, nd2a,nd2b,nThreads
  real rx,ry
  ...
  ! local variables
  integer i1,i2
  !$omp parallel num_threads(nThreads) shared(u, un, rx, ry) private(i1, i2)
  !$omp do collapse(2)
  do i2=n2a,n2b
     do i1=n1a,n1b
